...
data = pandas.read_csv(cvsFile, usecols=['TAXON_ID','SCIENTIFIC_NAME','COMMON_NAME','TAXON_TYPE',
	                                     'PRIMARY_DISCIPLINE','SCIENTIFIC_NME_SYNONYM','ORIGIN',
	                                     'FFG_ACT_STATUS','EPBC_ACT_STATUS','VIC_ADVISORY_STATUS',
	                                     'COMMON_NME_SYNONYM', 'LAST_MOD','EXTRACT_DATE'],  dtype=object)
